...
- **Root Project Documentation**:
  ...
  - **[.vscode/settings.json](file:///C:/NEW%20RUN%20RAID/.vscode/settings.json)**: Workspace settings to exclude `.dart_tool/` files from being parsed as C++ syntax by VS Code IntelliSense.
